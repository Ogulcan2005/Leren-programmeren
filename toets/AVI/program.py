...
# functions
def calculate():
    textToBeCalculated = calculateInput.get('0.0', 'end') # get all the text from inputfield
    ...
    scoreLabel.config(text=f"Score: {aviScore(textToBeCalculated)}")
...
wordsLabel = tk.Label(root, text=f'Woorden:', width=15, bg='black', fg='white')
scoreLabel = tk.Label(root, text=f'Score:', width=15, bg='black', fg='white')
